import {PixKeyValueObject} from "./pix-key.vo";
...
describe("PixKeyValueObject Unit Test", () => {
    ...
    test("Creating a new entity with phone", () => {
        ...
        expect(entity.kind).toBe(PixKeyValueObject.Kind.PHONE);
    })
    ...
    test("Creating a new entity with document", () => {
        ...
        expect(entity.kind).toBe(PixKeyValueObject.Kind.DOCUMENT);
    })
    ...
    test("Creating a new entity with email", () => {
        ...
        expect(entity.kind).toBe(PixKeyValueObject.Kind.EMAIL);
    });
})